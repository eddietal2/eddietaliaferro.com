...
let BlogService = class BlogService {
    ...
    getBlogs() {
        ...
        return this.http.get(`${this.BLOG_BACKEND_URL}/blog/get-blog-posts`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(error => {
            console.log(error);
    ...
    getLatestBlogPosts() {
        console.log('Getting Blogs from Blog Service');
        return this.http.get(`${this.BLOG_BACKEND_URL}/blog/get-latest-blog-posts`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(error => {
            console.log(error);
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)([]);
        }));
    }
    getBlogInfo(blogID) {
        return this.http.post(`${this.BLOG_BACKEND_URL}/blog/get-blog-info`, { id: blogID }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(error => {
            console.log(error);
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)([]);
        }));
    }
    submitBlog(blog) {
        ...
        return this.http.post(`${this.BLOG_BACKEND_URL}/blog/add-blog`, blog);
    }
    editBlog(blog) {
        console.log(blog);
    ...
    deleteBlog(blogID) {
        ...
        return this.http.post(`${this.BLOG_BACKEND_URL}/blog/delete-blog`, { id: blogID });
    }
    blogVisibility(blogID, title, visible) {
        console.log('Visibility ...');
        return this.http.post(`${this.BLOG_BACKEND_URL}/blog/toggle-visibility`, { id: blogID, visible, title });
    }
    comment(blogID, name, picture, comment, userEmail) {
    ...
    editReply(blogID, commentID, replyID, reply) {
...
BlogService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
//# sourceMappingURL=default-node_modules_date-fns_esm_format_index_js-node_modules_date-fns_esm_parseISO_index_js-3c5c83-es2015.js.map