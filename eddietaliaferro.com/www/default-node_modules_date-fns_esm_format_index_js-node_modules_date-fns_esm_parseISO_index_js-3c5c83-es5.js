(function () {
  ...
  (self["webpackChunkeddietaliaferro_com"] = self["webpackChunkeddietaliaferro_com"] || []).push([["default-node_modules_date-fns_esm_format_index_js-node_modules_date-fns_esm_parseISO_index_js-3c5c83"], {
    /***/
    19186:
    /*!*****************************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _BlogService = /*#__PURE__*/function () {
        ...
        _createClass(BlogService, [{
          ...
          value: function getBlogs() {
            ...
            return this.http.get("".concat(this.BLOG_BACKEND_URL, "/blog/get-blog-posts")).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(function (error) {
              console.log(error);
              return (0, rxjs__WEBPACK_IMPORTED_MODULE_2__.of)([]);
            }));
          }
        }, {
          key: "getLatestBlogPosts",
          value: function getLatestBlogPosts() {
            console.log('Getting Blogs from Blog Service');
            return this.http.get("".concat(this.BLOG_BACKEND_URL, "/blog/get-latest-blog-posts")).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(function (error) {
              console.log(error);
              return (0, rxjs__WEBPACK_IMPORTED_MODULE_2__.of)([]);
            }));
          }
          ...
          key: "getBlogInfo",
          value: function getBlogInfo(blogID) {
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/get-blog-info"), {
              id: blogID
          ...
          key: "submitBlog",
          value: function submitBlog(blog) {
            console.log('Submitting Blogs ...');
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/add-blog"), blog);
          }
        }, {
          key: "editBlog",
          value: function editBlog(blog) {
            ...
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/edit-blog"), blog);
          }
        }, {
          key: "deleteBlog",
          value: function deleteBlog(blogID) {
            console.log('Deleting Blog ...');
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/delete-blog"), {
              id: blogID
            });
          }
        }, {
          key: "blogVisibility",
          value: function blogVisibility(blogID, title, visible) {
            console.log('Visibility ...');
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/toggle-visibility"), {
              id: blogID,
              visible: visible,
              title: title
            });
          ...
          key: "comment",
          value: function comment(blogID, name, picture, _comment, userEmail) {
            console.log('Commenting on Blog ...');
            console.log(userEmail);
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/add-comment"), {
              id: blogID,
              name: name,
              picture: picture,
              comment: _comment,
          ...
          key: "editComment",
          value: function editComment(blogID, commentID, comment) {
            console.log('Editting a Comment ...');
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/edit-comment"), {
              blogID: blogID,
              commentID: commentID,
              comment: comment
            });
          ...
          value: function deleteComment(blogID, commentID, userFullName, title) {
            ...
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/delete-comment"), {
              blogID: blogID,
              commentID: commentID,
          ...
          value: function reply(blogID, commentID, fullName, picture, _reply, email) {
            ...
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/add-reply"), {
              blogID: blogID,
              commentID: commentID,
              fullName: fullName,
              picture: picture,
          ...
          value: function deleteReply(blogID, commentID, replyID) {
            ...
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/delete-reply"), {
              blogID: blogID,
              commentID: commentID,
              replyID: replyID
            });
          ...
          key: "editReply",
          value: function editReply(blogID, commentID, replyID, reply) {
            console.log('Edit Reply ...');
            return this.http.post("".concat(this.BLOG_BACKEND_URL, "/blog/edit-reply"), {
              blogID: blogID,
              commentID: commentID,
              replyID: replyID,
              reply: reply
      ...
      _BlogService.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpClient
        }];
      };

      _BlogService = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)({
        providedIn: 'root'
      })], _BlogService);
      /***/
    }
...
//# sourceMappingURL=default-node_modules_date-fns_esm_format_index_js-node_modules_date-fns_esm_parseISO_index_js-3c5c83-es5.js.map