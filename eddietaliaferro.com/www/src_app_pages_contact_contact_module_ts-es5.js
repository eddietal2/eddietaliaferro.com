(function () {
  ...
  (self["webpackChunkeddietaliaferro_com"] = self["webpackChunkeddietaliaferro_com"] || []).push([["src_app_pages_contact_contact_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _ContactPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.ReactiveFormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, _contact_routing_module__WEBPACK_IMPORTED_MODULE_0__.ContactPageRoutingModule, src_app_components_custom_components_module__WEBPACK_IMPORTED_MODULE_2__.CustomComponentsModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ContactPage = /*#__PURE__*/function () {
        function ContactPage(formBuilder, modalController, alertController, contact, router) {
        ...
        _createClass(ContactPage, [{
          ...
          value: function sendMessage(data) {
            ...
            this.contact.sendMessage(data).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.tap)(function (res) {
              if (!res) {
                console.log('There was no response.');
              }
            }), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.catchError)(function (e) {
              console.error(e);

              if (e.error.msg === 'There was no message that saved.') {
                _this.presentAlert('Error', 'There was an error with sending the message. Please try again later');
              }

              if (e.error.msg === 'Message does not have all properties!') {
                _this.presentAlert('Form incomplete', 'The form needs all fields to be complete.');
              } else {
                _this.presentAlert('Server Error', 'There was an error with the server. Please come back later.');
              }
                  ...
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      ...
                      return modal.present()["catch"](function (e) {
                        ...
                        _this2.router.navigateByUrl('/contact');
      ...
      _ContactPage = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
