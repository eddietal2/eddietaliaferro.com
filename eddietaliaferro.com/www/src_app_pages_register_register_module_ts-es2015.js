...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_register_success_success_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./success/success.module */ 10143)).then(m => m.SuccessPageModule)
    }
];
...
/* harmony import */ var _Users_ferro_Desktop_personal_website_eddietaliaferro_com_node_modules_ngtools_webpack_src_loaders_direct_resource_js_register_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./register.page.html */ 12004);
...
/* harmony import */ var src_app_components_success_modal_success_modal_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/components/success-modal/success-modal.component */ 54575);
...
let RegisterPage = class RegisterPage {
    constructor(router, auth, alertController, modalController, pictureService, formBuilder) {
        this.router = router;
        this.auth = auth;
    ...
    register() {
        ...
        this.emailCheckSub = this.auth.checkEmail(email).subscribe(data => {
            console.log(data);
            if (data['isEmail']) {
    ...
    codeAlert(header, msg, fullName, picture, email, password) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            const alert = yield this.alertController.create({
                cssClass: 'danger-alert',
                header,
                        ...
                        handler: () => {
                            ...
                            if (this.validCode) {
                                ...
                                this.auth.register(fullName, picture, email, password)
                                    .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.tap)(res => {
                                    if (!res) {
                                        console.log('There was no response.');
                                    }
                                }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.catchError)(e => {
                                    console.error(e);
            ...
            yield alert.present().then(data => {
                ...
                // Send Code
                this.generateCode(6);
                this.codeSub = this.auth.sendRegistrationCode(this.registerForm.value.email, this.code).subscribe(data => {
